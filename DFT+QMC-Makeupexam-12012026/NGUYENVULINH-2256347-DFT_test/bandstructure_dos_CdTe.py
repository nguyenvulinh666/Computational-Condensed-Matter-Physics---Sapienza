...
atoms="CdTe"
Ef =  13.013  # Remember to update the value!
ne = 36
num_bands = 36
emin = -15
emax = 10

x_positions = [0.0000, 0.7071, 1.5731, 2.5731, 3.0731, 3.7802]
x_labels = ['W', 'L', r'$\Gamma$', 'X', 'W', 'L']
...
ax2.hlines(0, 0, 50.0, linestyle='--', color='b', label=r"EF") 
