...
atoms="si.cd"
Ef =  5.996 # Remember to update the value!
ne = 8
num_bands = 8
emin = -15
emax = 15
...
x_positions = [0.0000, 1.0000, 1.5000, 1.8536, 2.9142, 3.7802, 4.3926, 4.7462, 5.4533, 6.0656, 6.0656, 6.4192]
x_labels = [r'$\Gamma$', 'X', 'W', 'K', r'$\Gamma$', 'L', 'U', 'W', 'L', '', 'K|U',  'X'] 
