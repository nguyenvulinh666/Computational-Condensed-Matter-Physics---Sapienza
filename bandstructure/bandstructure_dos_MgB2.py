...
atoms="MgB2"
Ef =  9.240 # Remember to update the value!
ne = 16
num_bands = 16
emin = -15
emax = 10

x_positions = [0.0000, 0.5774, 0.9107, 1.5773, 2.0147, 2.5921]
x_labels = [r'$\Gamma$', 'M', 'K', r'$\Gamma$', 'A', 'L']
...
ax1.set_xlim(0.0,  x_positions[-1])
#ax1.set_ylim(-24,20)
## ## Special k points
...
for i in range(num_bands):
    ax1.plot(bands[i*num_pts:i*num_pts+num_pts,0], bands[i*num_pts:i*num_pts+num_pts,1], linestyle = '-', linewidth=2.0) #color = 'k'
## Plot Fermi level
